...
class RegisterPaymentInherit(models.Model):
    ...
    # Overriding this methos to pass cheque number on line number 22 move.update
    def _create_payment_entry(self, amount):
        ...
        move.update({'cheque_no': self.cheque_no})
